      ...
      <head>
        ...
        <style>
          ...
          *:focus-visible { outline: 2px solid #2b7fa1; outline-offset: 2px; }
          ...
          .detail-chip { font-family: 'Reddit Mono', monospace; font-size: 0.775rem; background: #f4f0e6; color: #4a4035; padding: 0.2rem 0.55rem; border-radius: 0.35rem; border: 1px solid #dfd5c6; display: inline-block; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.02); }
