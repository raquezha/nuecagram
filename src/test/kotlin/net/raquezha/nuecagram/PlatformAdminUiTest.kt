...
class PlatformAdminUiTest : BaseEventTestHelper() {
    ...
    fun platformAdminInstallationsDirectorySupportsSearchFiltersPaginationAndRedaction() =
        testApplication {
            ...
            assertThat(pageOneBody).contains("Page 1 of 2")
            assertThat(pageOneBody).contains("21 total result(s).")
            ...
            assertThat(pageTwoBody).contains("Page 2 of 2")
            assertThat(pageTwoBody).contains("Previous")
            ...
            assertThat(mutedBody).contains("1 total result(s).")
